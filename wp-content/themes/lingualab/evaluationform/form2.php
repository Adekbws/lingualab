<fieldset>
                            ...
                            <div class="row efFieldRow twoInputRow">
                                <div class="col-md-6 efField">
                                    <div class="efFieldContent">
                                        <div class="row efFieldContentRow">
                                            <label class="col-md-4 label" for=""><?php _e( 'tłumaczenia', 'lingualab' );?><br><?php _e( 'z oryginału / kopii', 'lingualab' );?></label>
                                            <div class="col-md-8 input">
                                            <select name="service_type">
                             ...
                             <div class="col-md-6 efField">
                                    <div class="efFieldContent">
                                        <div class="row efFieldContentRow">
                                            <label class="col-md-4 label" for=""><?php _e( 'Sposób dostawy:', 'lingualab' );?></label>
                                            <div class="col-md-8 input">
                                            <select name="service_type">
                                                <?php
