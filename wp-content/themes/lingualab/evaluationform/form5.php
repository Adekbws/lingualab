<fieldset>
                            <legend><?php _e( 'Szczegóły - Skład do druku (DTP)', 'lingualab' );?></legend>
                            <div class="row efFieldRow oneInputRow">
                            <div class="col-md-12 efField">
                                <div class="efFieldContent">
                                    <div class="row efFieldContentRow">
                                        <label class="col-md-4 label" for="evaluationFormService"><?php _e( 'Przeznaczenie', 'lingualab' );?><br><?php _e( 'dokumentu:', 'lingualab' );?></label>
                                        <div class="col-md-8 input">
                                        <select name="service_type" id="evaluationFormService">
                                          <?php
                                          $ship = get_field('destiny_doc',pll_get_post(103));
                                          $pieces = explode(";",$ship);
