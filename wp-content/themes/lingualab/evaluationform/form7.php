<fieldset>
                            <legend><?php _e( 'Szczegóły - Lokalizacja', 'lingualab' );?></legend>
                            <div class="row efFieldRow oneInputRow">
                            <div class="col-md-12 efField">
                                <div class="efFieldContent">
                                    <div class="row efFieldContentRow">
                                        <label class="col-md-4 label" for="service_kind"><?php _e( 'Rodzaj usługi:', 'lingualab' );?></label>
                                        <div class="col-md-8 input">
                                        <select name="evaluation_form[service_kind]" id="service_kind">
                                          <?php
                                          $location = get_field('location_type',pll_get_post(103));
