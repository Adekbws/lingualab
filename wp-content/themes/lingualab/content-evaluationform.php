                ...
                <form method="post" id="evaluationForm">
                                ...
                                <div class="efFieldContent">
                                    <div class="row efFieldContentRow">
                                        ...
                                        <div class="col-md-8 input requiredField">
                                            <input id="client_name" type="text" name="evaluation_form[client_name]" autocomplete="off" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 efField">
                                <div class="efFieldContent">
                                    <div class="row efFieldContentRow">
                                        ...
                                        <div class="col-md-8 input requiredField">
                                            <input id="client_surname" type="text" name="evaluation_form[client_surname]" autocomplete="off" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 efField">
                                <div class="efFieldContent">
                                    <div class="row efFieldContentRow">
                                        ...
                                        <div class="col-md-8 input requiredField client_email">
                                            <input id="client_email" type="email" name="evaluation_form[client_email]" autocomplete="off" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 efField">
                                <div class="efFieldContent">
                                    <div class="row efFieldContentRow">
                                        ...
                                        <div class="col-md-8 input requiredField">
                                            <input id="client_phone" type="text" name="evaluation_form[client_phone]" autocomplete="off" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 efField">
                                <div class="efFieldContent">
                                    <div class="row efFieldContentRow">
                                        ...
                                        <div class="col-md-8 input requiredField">
                                            <input id="client_company" type="text" name="evaluation_form[client_company]" autocomplete="off" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="efFieldContent">
                                    <div class="row efFieldContentRow">
                                        ...
                                        <div class="col-md-8 input">
                                            <input id="client_q" type="text" name="evaluation_form[client_q]" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 efField">
                                <div class="efFieldContent">
                                    <div class="row efFieldContentRow">
                                        ...
                                        <div class="col-md-8 input">
                                        <select name="evaluation_form[service_type]" id="evaluationFormService">
                                            ...
                                            <option value="6"><?php _e( 'Korekta Native Speakera', 'lingualab' );?></option>
                    ...
                    <div class="row evaluationFormSemdWrapper">
                        <div class="col-md-12 rodoCheckWrapper">
                            <input type="checkbox" name="evaluation_form[rodo]" id="rodoCheck" value="1" required>
                        ...
                        <div class="col-md-12 evaluateResponse" id="evaluateResponse"></div>
